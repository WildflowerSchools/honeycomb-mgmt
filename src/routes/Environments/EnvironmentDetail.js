                ...
                <Col>
                    <Card style={{ width: '18rem' }}>
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>
                          Sed convallis rhoncus lorem, ut condimentum diam fermentum eget. Donec et massa velit.
                        </Card.Text>
                  ...
                  <Col>
                    <Card style={{ width: '18rem' }}>
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>
                          Duis faucibus mattis nibh id commodo. Vestibulum pulvinar mi ut nunc convallis, non facilisis elit faucibus.
                        </Card.Text>
                        <Button variant="primary">Go somewhere</Button>
                      </Card.Body>
                    </Card>
                  ...
                  <Col>
                    <Card style={{ width: '18rem' }}>
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>
                          Cras suscipit dui et libero accumsan, ac mattis ipsum accumsan. Etiam pretium facilisis erat.
                        </Card.Text>
                        <Button variant="primary">Go somewhere</Button>
                      </Card.Body>
                    </Card>
                  ...
                  <Col>
                    <Card style={{ width: '18rem' }}>
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>
                          Suspendisse faucibus dolor ac lacinia pretium. Sed ultricies pulvinar eros, in finibus augue eleifend eget.
                        </Card.Text>
                        <Button variant="primary">Go somewhere</Button>
                      </Card.Body>
                    </Card>
